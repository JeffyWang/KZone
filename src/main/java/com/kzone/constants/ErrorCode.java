...
public class ErrorCode {
    ...
    public static String GET_USER_ERR_MSG = "Get user's information error : ";
    public static String GET_USER_LIST_ERR_CODE = "KU003";
    public static String GET_USER_LIST_ERR_MSG = "Get users' information error : ";
