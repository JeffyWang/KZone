 ...
 */
public class PicBucketServiceImpl {

	// 运行前先设置好以下三个参数
	private static final String BUCKET_NAME = "kzone";
	private static final String USER_NAME = "wjfdwr";
	private static final String USER_PWD = "wjfwjf456789";
...
//			.getProperty("user.dir") + "/sample.jpeg";
    private static final String SAMPLE_PIC_FILE = "C:\\Users\\Administrator\\Desktop\\java-sdk-master\\sample.jpeg";
	 ...
	 * @throws java.io.IOException
	 */
	public static void gmkerl() throws IOException {

		// 要传到upyun后的文件路径
		String filePath = DIR_ROOT + "gmkerl6.jpg";
		...
		params.put(UpYun.PARAMS.KEY_X_GMKERL_VALUE.getValue(), upyun.getPicWidth() + "x" + upyun.getPicHeight());
		...
		params.put(UpYun.PARAMS.KEY_X_GMKERL_THUMBNAIL.getValue(), "kzone");
